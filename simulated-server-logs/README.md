...
This script generates a boatload of fake apache logs very quickly. Its useful for generating fake workloads for [data ingest](https://github.com/siddd88/google-cloud/simulated-server-logs) and/or analytics applications.
